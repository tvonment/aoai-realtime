    ...
    this.client.sendItem(
      {
        type: "message", role: "system", content: [
          { type: "input_text", text: "You are an expert about this sculpture and talk with the user about it." },
        ]
      }
    );
    this.client.sendItem(
      {
        type: "message", role: "system", content: [
          { type: "input_text", text: "Here is an image of Michelangelo's David: https://cdn.britannica.com/77/196577-050-1101EEBD/Michelangelos-David-Goliath-one-statues-world.jpg" },
        ]
      }
    );
    this.client.sendItem(
      {
        type: "message", role: "user", content: [
          { type: "input_text", text: "Give me a summary of this sculpture." },
        ]
      }
    );
    try {
